...
Основной алгоритм — это **трансформация данных (Mapping/Normalization)**. Для каждого входящего JSON ответа применяется фиксированный набор правил: извлечение пары (Валюта, Курс) и умножение/деление на коэффициент для приведения к базовой валюте (например, USD).
